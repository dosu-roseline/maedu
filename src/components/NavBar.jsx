...
function NavBar() {
  return (
    <header className="bg-[#160632] px-[20px] md:px-[50px] py-4 sticky top-0 z-50">
      <div className="flex items-center justify-between md:border-b-[0.5px] border-[#CBCAD3] pb-4">
        <Link to="/">
        ...
        <input
          type="text"
          placeholder="Search"
          className="hidden md:block bg-[#CBCAD3] py-2 px-5 w-[30%] rounded-lg outline-none placeholder:text-white"
        />
